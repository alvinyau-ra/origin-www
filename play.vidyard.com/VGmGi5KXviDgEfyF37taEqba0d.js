var vidyard_player_width_VGmGi5KXviDgEfyF37taEq = 640;
var vidyard_player_height_VGmGi5KXviDgEfyF37taEq = 360;
var vidyard_html5_VGmGi5KXviDgEfyF37taEq = false;
var vidyard_secure_VGmGi5KXviDgEfyF37taEq = false;
var vidyard_integration_check_VGmGi5KXviDgEfyF37taEq = function() {};
var vidyard_VGmGi5KXviDgEfyF37taEq_params = {};
var vidyard_VGmGi5KXviDgEfyF37taEq_raw_params = '';
...
(function() {
  ...
  var embed_script = document.getElementById('vidyard_embed_code_VGmGi5KXviDgEfyF37taEq');
  var playerDetails = {"keywords":"loto,Unlock the Value of Lockout/Tagout Services from Rockwell Automation,lockout/tagout services,safety services,yt:cc=on","thumbnailUrl":"https://play.vidyard.com/VGmGi5KXviDgEfyF37taEq.jpg","@context":"http://schema.org/","@type":"VideoObject","id":"VGmGi5KXviDgEfyF37taEq","description":"Our comprehensive lockout/tagout solutions could be just what you need to improve your company’s safety track record and productivity. Learn about the five essential components of a LOTO program – graphical procedures, employee training, annual program auditing, policy review, and device recommendations – as well as our cutting-edge software.\r\n\r\nEmployee safety, regulatory compliance and increased productivity are all within reach. Visit rok.auto/LOTO to learn more. \r\n","name":"Unlock the Value of Lockout/Tagout Services from Rockwell Automation","transcript":"","uploadDate":"2019-06-24T20:41:23.000Z","duration":"T2M32S","embedUrl":"https://play.vidyard.com/VGmGi5KXviDgEfyF37taEq","height":360,"width":640};
  ...
  function check_for_duplicate_embeds() {
    ...
    for (var i = 0; i < all_scripts.length; ++i) {
      if (all_scripts[i].getAttribute('id') === "vidyard_embed_code_VGmGi5KXviDgEfyF37taEq") {
    ...
    if (dupe_scripts.length >= 1) {
      ...
      if (typeof document.querySelectorAll === 'function') {
        ...
        for (var i = 0; i < wrappers.length; ++i) {
          if (wrappers[i].getAttributeNode('onclick').value === "fn_vidyard_VGmGi5KXviDgEfyF37taEq();") {
  ...
  if (!embed_script || !embed_script.src) {
    ...
    for (var i in scripts) {
      ...
      if (script.src && /^.+(vidyard\.com).*\/VGmGi5KXviDgEfyF37taEq.*/.test(script.src)) {
        embed_script = script;
        break;
      }
    }
  ...
  if (embed_script && embed_script.src) {
    ...
    vidyard_VGmGi5KXviDgEfyF37taEq_raw_params = rawQueryParams;
    ...
    embed_script.src.replace(/(?:[\?&])([^&=]*)=?([^&#]*)/g, function ($0, $1, $2) {
      if ($1) {
        switch ($1) {
          ...
          case 'vylegacy':
            vidyard_VGmGi5KXviDgEfyF37taEq_params[$1] = (parseInt($2, 10) !== 0);
            break;
          case 'chapter':
            vidyard_VGmGi5KXviDgEfyF37taEq_params[$1] = parseInt($2, 10);
            break;
          case 'width':
          ...
          case 'height':
            ...
            break;
          case 'X-VY-Signature':
            vidyard_secure_VGmGi5KXviDgEfyF37taEq = true;
          default:
            vidyard_VGmGi5KXviDgEfyF37taEq_params[$1] = $2;
            break;
        }
      }
    });
  ...
  if (!vidyard_VGmGi5KXviDgEfyF37taEq_params.type || vidyard_VGmGi5KXviDgEfyF37taEq_params.type !== 'lightbox') {
    vidyard_VGmGi5KXviDgEfyF37taEq_params.type = 'inline';
  }

  // Determine Player Settings which effect embed
  var multi_chapter = false && !(typeof vidyard_VGmGi5KXviDgEfyF37taEq_params.hide_html5_playlist !== 'undefined' && vidyard_VGmGi5KXviDgEfyF37taEq_params.hide_html5_playlist);
  var playlist_always_open = false;
  if (typeof vidyard_VGmGi5KXviDgEfyF37taEq_params.playlist_always_open !== 'undefined') {
    playlist_always_open = vidyard_VGmGi5KXviDgEfyF37taEq_params.playlist_always_open;
  }
  ...
  if (query_player_width && query_player_width > 0 && query_player_height && query_player_height > 0) {
    vidyard_player_width_VGmGi5KXviDgEfyF37taEq = query_player_width;
    vidyard_player_height_VGmGi5KXviDgEfyF37taEq = query_player_height;
  } else if (query_player_width && query_player_width > 0) {
    query_player_height = (query_player_width * vidyard_player_height_VGmGi5KXviDgEfyF37taEq) / vidyard_player_width_VGmGi5KXviDgEfyF37taEq;
    vidyard_player_width_VGmGi5KXviDgEfyF37taEq = query_player_width;
    vidyard_player_height_VGmGi5KXviDgEfyF37taEq = query_player_height;
  } else if (query_player_height && query_player_height > 0) {
    query_player_width = (query_player_height * vidyard_player_width_VGmGi5KXviDgEfyF37taEq) / vidyard_player_height_VGmGi5KXviDgEfyF37taEq;
    vidyard_player_width_VGmGi5KXviDgEfyF37taEq = query_player_width;
    vidyard_player_height_VGmGi5KXviDgEfyF37taEq = query_player_height;
  }

  var iframe_container = document.getElementById("vidyard_VGmGi5KXviDgEfyF37taEq");
  ...
  if (!iframe_container && vidyard_VGmGi5KXviDgEfyF37taEq_params.type === 'inline') {
    iframe_container = document.createElement("span");
    iframe_container.id = 'vidyard_VGmGi5KXviDgEfyF37taEq';
  ...
  if (vidyard_secure_VGmGi5KXviDgEfyF37taEq === false) {
    // Get cookie data/ids from various MAPs/CRMs
    var pardot_id = fn_getCookie("pardot");
    if (pardot_id) {
      vidyard_VGmGi5KXviDgEfyF37taEq_params.pardot_id = pardot_id;
    }

    var hubspot_id = fn_getCookie("hubspotutk");
    if (hubspot_id) {
      vidyard_VGmGi5KXviDgEfyF37taEq_params.hubspot_id = hubspot_id;
    }
    ...
    if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
      vidyard_VGmGi5KXviDgEfyF37taEq_params.marketo_id = encodeURIComponent(marketo_id);
    }

    var dreamforce_id = fn_getCookie("vy_dreamforce");
    if (dreamforce_id) {
      vidyard_VGmGi5KXviDgEfyF37taEq_params.dreamforce_id = encodeURIComponent(dreamforce_id);
    }
    ...
    if (vycustom_id !== "") {
      vidyard_VGmGi5KXviDgEfyF37taEq_params.custom_id = vycustom_id;
    }

    // Gets the vyemail query string param, which connects views to an email entered
    var vyemail = get_parameter_by_name('vyemail');
    if (vyemail !== "") {
      vidyard_VGmGi5KXviDgEfyF37taEq_params.email = vyemail;
    }

    var vyac = get_parameter_by_name('vyac');
    var vyplayer = get_parameter_by_name('vyplayer');
    if (vyplayer === 'VGmGi5KXviDgEfyF37taEq') {
      vidyard_VGmGi5KXviDgEfyF37taEq_params.access_code = vyac;
    }
  }
  ...
  if (navigator.userAgent.toLowerCase().match(/ip(ad|od|hone)|android/)) {
    vidyard_html5_VGmGi5KXviDgEfyF37taEq = true;
    vidyard_VGmGi5KXviDgEfyF37taEq_params.disable_popouts = true;
  }
  ...
  function create_embed() {
    ...
    var integration_tracking_check = function() {
      if (playerReady) {
        ...
        window.addEventListener('message', function callback(e) {
          ...
          if (data.event === "ready" && data.uuid === "VGmGi5KXviDgEfyF37taEq") {
    ...
    var integration_tracking_check_original = function () {
      ...
      if (!referringUrlSent && vidyard_secure_VGmGi5KXviDgEfyF37taEq === true && vidyard_VGmGi5KXviDgEfyF37taEq_params.referring_url) {
        var playerFrame = Vidyard.Helpers.getPlayerIFrame('VGmGi5KXviDgEfyF37taEq');
        var message = {
          'event': 'parentReferer',
          'uuid': 'VGmGi5KXviDgEfyF37taEq',
          'data': {
            'value': vidyard_VGmGi5KXviDgEfyF37taEq_params.referring_url
          }
        }
      ...
      if (!vidyard_VGmGi5KXviDgEfyF37taEq_params.pardot_id) {
        var pardot_id = fn_getCookie("pardot");
        if (pardot_id) {
          vidyard_VGmGi5KXviDgEfyF37taEq_params.pardot_id = pardot_id;
      ...
      if (!vidyard_VGmGi5KXviDgEfyF37taEq_params.hubspot_id) {
        var hubspot_id = fn_getCookie("hubspotutk");
        if (hubspot_id) {
          vidyard_VGmGi5KXviDgEfyF37taEq_params.hubspot_id = hubspot_id;
      ...
      if (!vidyard_VGmGi5KXviDgEfyF37taEq_params.dreamforce_id) {
        var dreamforce_id = fn_getCookie("vy_dreamforce");
        if (dreamforce_id) {
          dreamforce_id = encodeURIComponent(dreamforce_id);
          vidyard_VGmGi5KXviDgEfyF37taEq_params.dreamforce_id = dreamforce_id;
          messages.push({'data': {'type': 'dreamforce', 'value': dreamforce_id}});
        }
      }
      if (!vidyard_VGmGi5KXviDgEfyF37taEq_params.marketo_id) {
        var marketo_id = fn_getCookie("_mkto_trk");
        var munchkin_id = '';
        
        if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
          marketo_id = encodeURIComponent(marketo_id);
          vidyard_VGmGi5KXviDgEfyF37taEq_params.marketo_id = marketo_id;
        ...
        if (!eloquaSent &&
            vidyard_VGmGi5KXviDgEfyF37taEq_params.eloqua_id &&
            ((vidyard_secure_VGmGi5KXviDgEfyF37taEq === true && vidyard_VGmGi5KXviDgEfyF37taEq_params.type === 'lightbox') ||
             (vidyard_VGmGi5KXviDgEfyF37taEq_params.type === 'inline'))) {
          eloquaSent = true;
          messages.push({'data': {'type': 'eloqua', 'value': vidyard_VGmGi5KXviDgEfyF37taEq_params.eloqua_id}});
        }
      

      // inline embeds are ready to receive api requests
      // lightbox will pass data through querystring params
      if (vidyard_VGmGi5KXviDgEfyF37taEq_params.type === "inline" || vidyard_secure_VGmGi5KXviDgEfyF37taEq === true) {
        for(var i in messages) {
          messages[i].event = 'associateVisitor';
          messages[i].uuid = 'VGmGi5KXviDgEfyF37taEq';
          Vidyard.Helpers.getPlayerIFrame('VGmGi5KXviDgEfyF37taEq').contentWindow.postMessage(JSON.stringify(messages[i]), window.location.protocol + '//play.vidyard.com');
        }
      }
    ...
    vidyard_integration_check_VGmGi5KXviDgEfyF37taEq = integration_tracking_check;

    // Display the inline or lightbox
    if (vidyard_VGmGi5KXviDgEfyF37taEq_params.type === "inline") {
      // Load the iframe
      iframe_container.innerHTML = fn_vidyard_build_iframe_VGmGi5KXviDgEfyF37taEq(false, vidyard_player_width_VGmGi5KXviDgEfyF37taEq, vidyard_player_height_VGmGi5KXviDgEfyF37taEq);

      Vidyard.Helpers.addListener(
        'load',
        'onload',
        function() {
          fn_vidyard_iframe_after_load_VGmGi5KXviDgEfyF37taEq();
          integration_tracking_check();
        },
        Vidyard.Helpers.getPlayerIFrame('VGmGi5KXviDgEfyF37taEq')
      );

    } else if (vidyard_VGmGi5KXviDgEfyF37taEq_params.type === "lightbox") {
      ...
      if (document.readyState === 'complete') {
        if (!vidyard_secure_VGmGi5KXviDgEfyF37taEq) {
          integration_tracking_check();
        }
    ...
    function getEloquaCookie() {
      if (timerId !== null) {
        ...
        if (typeof this.GetElqCustomerGUID === 'function') {
          ...
          vidyard_VGmGi5KXviDgEfyF37taEq_params.eloqua_id = eloqua_id;
          return;
        } else if (this._elqQ) {
  ...
  Vidyard._players['VGmGi5KXviDgEfyF37taEq'] = '';
}());
...
var vyContactCallback = function(data) {
  ...
  vidyard_VGmGi5KXviDgEfyF37taEq_params.marketo_lead = marketoData;
  ...
  // or tried again after IFrame loads in fn_vidyard_iframe_after_load_VGmGi5KXviDgEfyF37taEq
  playerIframe = Vidyard.Helpers.getPlayerIFrame('VGmGi5KXviDgEfyF37taEq');
  if ( playerIframe ) {
    message = {'data': {'type': 'marketo', 'value': marketoData}};
    message.event = 'identifyVisitor';
    message.uuid = 'VGmGi5KXviDgEfyF37taEq';
...
(function () {
  function async_load() {
    var contactId = vidyard_VGmGi5KXviDgEfyF37taEq_params.marketo_id;
    if (!contactId) {
    ...
    var url = window.location.protocol + '//play.vidyard.com'
        + '/v3/VGmGi5KXviDgEfyF37taEq/contact/' + encodeURIComponent(contactId) + '/marketoContact.js';
...
function fn_vidyard_build_iframe_VGmGi5KXviDgEfyF37taEq(lightbox, iframe_width, iframe_height) {
  if (lightbox) {
    vidyard_VGmGi5KXviDgEfyF37taEq_params.autoplay = true;
  }

  var referring_url = encodeURIComponent(document.referrer);
  if (referring_url) {
    vidyard_VGmGi5KXviDgEfyF37taEq_params.referring_url = referring_url;
  }
  ...
  if (document.documentMode === 7) {
    ...
    var ie7RepaintIframe = function() {
      var iframe = Vidyard.Helpers.getPlayerIFrame('VGmGi5KXviDgEfyF37taEq');
  ...
  if (vidyard_secure_VGmGi5KXviDgEfyF37taEq === true) {
    query_params_string = vidyard_VGmGi5KXviDgEfyF37taEq_raw_params;
  } else {
    for (var param in vidyard_VGmGi5KXviDgEfyF37taEq_params) {
      var param_value = vidyard_VGmGi5KXviDgEfyF37taEq_params[param];
      if (param_value === true) {
        param_value = '1';
      }
  ...
  return '<span id="vidyard_span_VGmGi5KXviDgEfyF37taEq" style="display: block; margin: auto; position: relative; width: ' + iframe_width + 'px; height: ' + iframe_height + 'px;"><iframe id="vidyard_iframe_VGmGi5KXviDgEfyF37taEq" class="vidyard_iframe" src="//play.vidyard.com/VGmGi5KXviDgEfyF37taEq?' + query_params_string + '" width="' + iframe_resizer + '" height="100%" title="Video" aria-label="Video" scrolling=no frameborder=0 allowtransparency="true" allowfullscreen allow="autoplay" style="opacity: 0; background-color: transparent; position: absolute; ' + ios_width_fix + ' right: 0px; top: 0px;"></iframe></span>';
}

// --- If the browser is FF, reload the iframe with the given id
function fn_vidyard_iframe_after_load_VGmGi5KXviDgEfyF37taEq() {
  var _theframe = Vidyard.Helpers.getPlayerIFrame('VGmGi5KXviDgEfyF37taEq');
  if (_theframe) {
    ...
    if (vidyard_secure_VGmGi5KXviDgEfyF37taEq === true && vidyard_VGmGi5KXviDgEfyF37taEq_params.type === 'lightbox') {
      vidyard_integration_check_VGmGi5KXviDgEfyF37taEq();
    }
    ...
    if (vidyard_VGmGi5KXviDgEfyF37taEq_params.marketo_lead) {
      var message = {'data': {'type': 'marketo', 'value': vidyard_VGmGi5KXviDgEfyF37taEq_params.marketo_lead }};
      message.event = 'identifyVisitor';
      message.uuid = 'VGmGi5KXviDgEfyF37taEq';
      Vidyard.Helpers.getPlayerIFrame('VGmGi5KXviDgEfyF37taEq')
...
function fn_vidyard_VGmGi5KXviDgEfyF37taEq() {
  var vidyard = {};
    ...
    return {
      show:function(initial_iframe_settings) {
        var showCore = function () {
          ...
          var width_height = this.lock_to_aspect_ratio(iframe_settings.width, iframe_settings.height, (319 + (vidyard_player_width_VGmGi5KXviDgEfyF37taEq / 5)));
      ...
      fill_iframe: function(settings_html_url, has_element, use_post_request, should_animate, width, height) {
        if(has_element) {
          if(iframe_settings.image) {
            ...
            this.set_tinner_size(fn_vidyard_build_iframe_VGmGi5KXviDgEfyF37taEq(true, width, height), should_animate, width, height);
          } else {
      ...
      resize: function() {
        ...
        var width_height = v_box.lock_to_aspect_ratio(
            vidyard_player_width_VGmGi5KXviDgEfyF37taEq,
            vidyard_player_height_VGmGi5KXviDgEfyF37taEq,
            319 + (vidyard_player_width_VGmGi5KXviDgEfyF37taEq / 5)
        );

        iframe_settings.width = width_height[0];
        iframe_settings.height = width_height[1];

        var vidyard_iframe = Vidyard.Helpers.getPlayerIFrame('VGmGi5KXviDgEfyF37taEq');
        var vidyard_span = document.getElementById('vidyard_span_VGmGi5KXviDgEfyF37taEq');
      ...
      fade_element: function(element_to_fade, fading_in, target_alpha) {
        ...
        if (old_opacity == target_alpha) {
          ...
          if (fading_in == -1) {
            ...
            Vidyard.Helpers.getPlayerIFrame('VGmGi5KXviDgEfyF37taEq').src = '';
  ...
  vidyard.box.show({
    iframe: '#', width: vidyard_player_width_VGmGi5KXviDgEfyF37taEq,
    height: vidyard_player_height_VGmGi5KXviDgEfyF37taEq,
    animate: !vidyard_html5_VGmGi5KXviDgEfyF37taEq,
    fixed: true
  });
}
