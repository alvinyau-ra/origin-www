var vidyard_player_width_6A1PUCWNhR2GgwkYEI6vuA = 640;
var vidyard_player_height_6A1PUCWNhR2GgwkYEI6vuA = 360;
var vidyard_html5_6A1PUCWNhR2GgwkYEI6vuA = false;
var vidyard_secure_6A1PUCWNhR2GgwkYEI6vuA = false;
var vidyard_integration_check_6A1PUCWNhR2GgwkYEI6vuA = function() {};
var vidyard_6A1PUCWNhR2GgwkYEI6vuA_params = {};
var vidyard_6A1PUCWNhR2GgwkYEI6vuA_raw_params = '';
...
(function() {
  ...
  var embed_script = document.getElementById('vidyard_embed_code_6A1PUCWNhR2GgwkYEI6vuA');
  var playerDetails = {"keywords":"EtherNet/IP,FactoryTalk ProductionCentre,FactoryTalk VantagePoint,IT/OT,Integrated Control and Information,The Connected Enterprise,Connected Enterprise,Internet of Things,IoT,Rockwell,Rockwell Automation,Rockwell Automation Journey","thumbnailUrl":"https://play.vidyard.com/6A1PUCWNhR2GgwkYEI6vuA.jpg","@context":"http://schema.org/","@type":"VideoObject","id":"6A1PUCWNhR2GgwkYEI6vuA","description":"Rockwell Automation, the world’s largest company dedicated to industrial automation and information solutions, understands the evolving industry challenges confronting global manufacturers – because we are one. As an evolution of our decades-long commitment to capturing enterprise data to make better decisions, we implemented an enterprise-wide strategy several years ago leveraging our integrated control and information portfolio to accelerate the business value of our Connected Enterprise. By integrating information across IT and OT, and from the plant floor across the enterprise, we have optimized our enterprise, plant and supply network performance and business agility. And now we are helping customers do the same.","name":"PT LA CE_Journey 25 NOV 16","transcript":"","uploadDate":"2015-11-06T15:47:26.000Z","duration":"T6M41S","embedUrl":"https://play.vidyard.com/6A1PUCWNhR2GgwkYEI6vuA","height":360,"width":640};
  ...
  function check_for_duplicate_embeds() {
    ...
    for (var i = 0; i < all_scripts.length; ++i) {
      if (all_scripts[i].getAttribute('id') === "vidyard_embed_code_6A1PUCWNhR2GgwkYEI6vuA") {
    ...
    if (dupe_scripts.length >= 1) {
      ...
      if (typeof document.querySelectorAll === 'function') {
        ...
        for (var i = 0; i < wrappers.length; ++i) {
          if (wrappers[i].getAttributeNode('onclick').value === "fn_vidyard_6A1PUCWNhR2GgwkYEI6vuA();") {
  ...
  if (!embed_script || !embed_script.src) {
    ...
    for (var i in scripts) {
      ...
      if (script.src && /^.+(vidyard\.com).*\/6A1PUCWNhR2GgwkYEI6vuA.*/.test(script.src)) {
        embed_script = script;
        break;
      }
    }
  ...
  if (embed_script && embed_script.src) {
    ...
    vidyard_6A1PUCWNhR2GgwkYEI6vuA_raw_params = rawQueryParams;
    ...
    embed_script.src.replace(/(?:[\?&])([^&=]*)=?([^&#]*)/g, function ($0, $1, $2) {
      if ($1) {
        switch ($1) {
          ...
          case 'vylegacy':
            vidyard_6A1PUCWNhR2GgwkYEI6vuA_params[$1] = (parseInt($2, 10) !== 0);
            break;
          case 'chapter':
            vidyard_6A1PUCWNhR2GgwkYEI6vuA_params[$1] = parseInt($2, 10);
            break;
          case 'width':
          ...
          case 'height':
            ...
            break;
          case 'X-VY-Signature':
            vidyard_secure_6A1PUCWNhR2GgwkYEI6vuA = true;
          default:
            vidyard_6A1PUCWNhR2GgwkYEI6vuA_params[$1] = $2;
            break;
        }
      }
    });
  ...
  if (!vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.type || vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.type !== 'lightbox') {
    vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.type = 'inline';
  }

  // Determine Player Settings which effect embed
  var multi_chapter = false && !(typeof vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.hide_html5_playlist !== 'undefined' && vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.hide_html5_playlist);
  var playlist_always_open = false;
  if (typeof vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.playlist_always_open !== 'undefined') {
    playlist_always_open = vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.playlist_always_open;
  }
  ...
  if (query_player_width && query_player_width > 0 && query_player_height && query_player_height > 0) {
    vidyard_player_width_6A1PUCWNhR2GgwkYEI6vuA = query_player_width;
    vidyard_player_height_6A1PUCWNhR2GgwkYEI6vuA = query_player_height;
  } else if (query_player_width && query_player_width > 0) {
    query_player_height = (query_player_width * vidyard_player_height_6A1PUCWNhR2GgwkYEI6vuA) / vidyard_player_width_6A1PUCWNhR2GgwkYEI6vuA;
    vidyard_player_width_6A1PUCWNhR2GgwkYEI6vuA = query_player_width;
    vidyard_player_height_6A1PUCWNhR2GgwkYEI6vuA = query_player_height;
  } else if (query_player_height && query_player_height > 0) {
    query_player_width = (query_player_height * vidyard_player_width_6A1PUCWNhR2GgwkYEI6vuA) / vidyard_player_height_6A1PUCWNhR2GgwkYEI6vuA;
    vidyard_player_width_6A1PUCWNhR2GgwkYEI6vuA = query_player_width;
    vidyard_player_height_6A1PUCWNhR2GgwkYEI6vuA = query_player_height;
  }

  var iframe_container = document.getElementById("vidyard_6A1PUCWNhR2GgwkYEI6vuA");
  ...
  if (!iframe_container && vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.type === 'inline') {
    iframe_container = document.createElement("span");
    iframe_container.id = 'vidyard_6A1PUCWNhR2GgwkYEI6vuA';
  ...
  if (vidyard_secure_6A1PUCWNhR2GgwkYEI6vuA === false) {
    // Get cookie data/ids from various MAPs/CRMs
    var pardot_id = fn_getCookie("pardot");
    if (pardot_id) {
      vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.pardot_id = pardot_id;
    }

    var hubspot_id = fn_getCookie("hubspotutk");
    if (hubspot_id) {
      vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.hubspot_id = hubspot_id;
    }
    ...
    if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
      vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.marketo_id = encodeURIComponent(marketo_id);
    }

    var dreamforce_id = fn_getCookie("vy_dreamforce");
    if (dreamforce_id) {
      vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.dreamforce_id = encodeURIComponent(dreamforce_id);
    }
    ...
    if (vycustom_id !== "") {
      vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.custom_id = vycustom_id;
    }

    // Gets the vyemail query string param, which connects views to an email entered
    var vyemail = get_parameter_by_name('vyemail');
    if (vyemail !== "") {
      vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.email = vyemail;
    }

    var vyac = get_parameter_by_name('vyac');
    var vyplayer = get_parameter_by_name('vyplayer');
    if (vyplayer === '6A1PUCWNhR2GgwkYEI6vuA') {
      vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.access_code = vyac;
    }
  }
  ...
  if (navigator.userAgent.toLowerCase().match(/ip(ad|od|hone)|android/)) {
    vidyard_html5_6A1PUCWNhR2GgwkYEI6vuA = true;
    vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.disable_popouts = true;
  }
  ...
  function create_embed() {
    ...
    var integration_tracking_check = function() {
      if (playerReady) {
        ...
        window.addEventListener('message', function callback(e) {
          ...
          if (data.event === "ready" && data.uuid === "6A1PUCWNhR2GgwkYEI6vuA") {
    ...
    var integration_tracking_check_original = function () {
      ...
      if (!referringUrlSent && vidyard_secure_6A1PUCWNhR2GgwkYEI6vuA === true && vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.referring_url) {
        var playerFrame = Vidyard.Helpers.getPlayerIFrame('6A1PUCWNhR2GgwkYEI6vuA');
        var message = {
          'event': 'parentReferer',
          'uuid': '6A1PUCWNhR2GgwkYEI6vuA',
          'data': {
            'value': vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.referring_url
          }
        }
      ...
      if (!vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.pardot_id) {
        var pardot_id = fn_getCookie("pardot");
        if (pardot_id) {
          vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.pardot_id = pardot_id;
      ...
      if (!vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.hubspot_id) {
        var hubspot_id = fn_getCookie("hubspotutk");
        if (hubspot_id) {
          vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.hubspot_id = hubspot_id;
      ...
      if (!vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.dreamforce_id) {
        var dreamforce_id = fn_getCookie("vy_dreamforce");
        if (dreamforce_id) {
          dreamforce_id = encodeURIComponent(dreamforce_id);
          vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.dreamforce_id = dreamforce_id;
          messages.push({'data': {'type': 'dreamforce', 'value': dreamforce_id}});
        }
      }
      if (!vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.marketo_id) {
        var marketo_id = fn_getCookie("_mkto_trk");
        var munchkin_id = '';
        
        if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
          marketo_id = encodeURIComponent(marketo_id);
          vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.marketo_id = marketo_id;
        ...
        if (!eloquaSent &&
            vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.eloqua_id &&
            ((vidyard_secure_6A1PUCWNhR2GgwkYEI6vuA === true && vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.type === 'lightbox') ||
             (vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.type === 'inline'))) {
          eloquaSent = true;
          messages.push({'data': {'type': 'eloqua', 'value': vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.eloqua_id}});
        }
      

      // inline embeds are ready to receive api requests
      // lightbox will pass data through querystring params
      if (vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.type === "inline" || vidyard_secure_6A1PUCWNhR2GgwkYEI6vuA === true) {
        for(var i in messages) {
          messages[i].event = 'associateVisitor';
          messages[i].uuid = '6A1PUCWNhR2GgwkYEI6vuA';
          Vidyard.Helpers.getPlayerIFrame('6A1PUCWNhR2GgwkYEI6vuA').contentWindow.postMessage(JSON.stringify(messages[i]), window.location.protocol + '//play.vidyard.com');
        }
      }
    ...
    vidyard_integration_check_6A1PUCWNhR2GgwkYEI6vuA = integration_tracking_check;

    // Display the inline or lightbox
    if (vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.type === "inline") {
      // Load the iframe
      iframe_container.innerHTML = fn_vidyard_build_iframe_6A1PUCWNhR2GgwkYEI6vuA(false, vidyard_player_width_6A1PUCWNhR2GgwkYEI6vuA, vidyard_player_height_6A1PUCWNhR2GgwkYEI6vuA);

      Vidyard.Helpers.addListener(
        'load',
        'onload',
        function() {
          fn_vidyard_iframe_after_load_6A1PUCWNhR2GgwkYEI6vuA();
          integration_tracking_check();
        },
        Vidyard.Helpers.getPlayerIFrame('6A1PUCWNhR2GgwkYEI6vuA')
      );

    } else if (vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.type === "lightbox") {
      ...
      if (document.readyState === 'complete') {
        if (!vidyard_secure_6A1PUCWNhR2GgwkYEI6vuA) {
          integration_tracking_check();
        }
    ...
    function getEloquaCookie() {
      if (timerId !== null) {
        ...
        if (typeof this.GetElqCustomerGUID === 'function') {
          ...
          vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.eloqua_id = eloqua_id;
          return;
        } else if (this._elqQ) {
  ...
  Vidyard._players['6A1PUCWNhR2GgwkYEI6vuA'] = '';
}());
...
var vyContactCallback = function(data) {
  ...
  vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.marketo_lead = marketoData;
  ...
  // or tried again after IFrame loads in fn_vidyard_iframe_after_load_6A1PUCWNhR2GgwkYEI6vuA
  playerIframe = Vidyard.Helpers.getPlayerIFrame('6A1PUCWNhR2GgwkYEI6vuA');
  if ( playerIframe ) {
    message = {'data': {'type': 'marketo', 'value': marketoData}};
    message.event = 'identifyVisitor';
    message.uuid = '6A1PUCWNhR2GgwkYEI6vuA';
...
(function () {
  function async_load() {
    var contactId = vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.marketo_id;
    if (!contactId) {
    ...
    var url = window.location.protocol + '//play.vidyard.com'
        + '/v3/6A1PUCWNhR2GgwkYEI6vuA/contact/' + encodeURIComponent(contactId) + '/marketoContact.js';
...
function fn_vidyard_build_iframe_6A1PUCWNhR2GgwkYEI6vuA(lightbox, iframe_width, iframe_height) {
  if (lightbox) {
    vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.autoplay = true;
  }

  var referring_url = encodeURIComponent(document.referrer);
  if (referring_url) {
    vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.referring_url = referring_url;
  }
  ...
  if (document.documentMode === 7) {
    ...
    var ie7RepaintIframe = function() {
      var iframe = Vidyard.Helpers.getPlayerIFrame('6A1PUCWNhR2GgwkYEI6vuA');
  ...
  if (vidyard_secure_6A1PUCWNhR2GgwkYEI6vuA === true) {
    query_params_string = vidyard_6A1PUCWNhR2GgwkYEI6vuA_raw_params;
  } else {
    for (var param in vidyard_6A1PUCWNhR2GgwkYEI6vuA_params) {
      var param_value = vidyard_6A1PUCWNhR2GgwkYEI6vuA_params[param];
      if (param_value === true) {
        param_value = '1';
      }
  ...
  return '<span id="vidyard_span_6A1PUCWNhR2GgwkYEI6vuA" style="display: block; margin: auto; position: relative; width: ' + iframe_width + 'px; height: ' + iframe_height + 'px;"><iframe id="vidyard_iframe_6A1PUCWNhR2GgwkYEI6vuA" class="vidyard_iframe" src="//play.vidyard.com/6A1PUCWNhR2GgwkYEI6vuA?' + query_params_string + '" width="' + iframe_resizer + '" height="100%" title="Video" aria-label="Video" scrolling=no frameborder=0 allowtransparency="true" allowfullscreen allow="autoplay" style="opacity: 0; background-color: transparent; position: absolute; ' + ios_width_fix + ' right: 0px; top: 0px;"></iframe></span>';
}

// --- If the browser is FF, reload the iframe with the given id
function fn_vidyard_iframe_after_load_6A1PUCWNhR2GgwkYEI6vuA() {
  var _theframe = Vidyard.Helpers.getPlayerIFrame('6A1PUCWNhR2GgwkYEI6vuA');
  if (_theframe) {
    ...
    if (vidyard_secure_6A1PUCWNhR2GgwkYEI6vuA === true && vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.type === 'lightbox') {
      vidyard_integration_check_6A1PUCWNhR2GgwkYEI6vuA();
    }
    ...
    if (vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.marketo_lead) {
      var message = {'data': {'type': 'marketo', 'value': vidyard_6A1PUCWNhR2GgwkYEI6vuA_params.marketo_lead }};
      message.event = 'identifyVisitor';
      message.uuid = '6A1PUCWNhR2GgwkYEI6vuA';
      Vidyard.Helpers.getPlayerIFrame('6A1PUCWNhR2GgwkYEI6vuA')
...
function fn_vidyard_6A1PUCWNhR2GgwkYEI6vuA() {
  var vidyard = {};
    ...
    return {
      show:function(initial_iframe_settings) {
        var showCore = function () {
          ...
          var width_height = this.lock_to_aspect_ratio(iframe_settings.width, iframe_settings.height, (319 + (vidyard_player_width_6A1PUCWNhR2GgwkYEI6vuA / 5)));
      ...
      fill_iframe: function(settings_html_url, has_element, use_post_request, should_animate, width, height) {
        if(has_element) {
          if(iframe_settings.image) {
            ...
            this.set_tinner_size(fn_vidyard_build_iframe_6A1PUCWNhR2GgwkYEI6vuA(true, width, height), should_animate, width, height);
          } else {
      ...
      resize: function() {
        ...
        var width_height = v_box.lock_to_aspect_ratio(
            vidyard_player_width_6A1PUCWNhR2GgwkYEI6vuA,
            vidyard_player_height_6A1PUCWNhR2GgwkYEI6vuA,
            319 + (vidyard_player_width_6A1PUCWNhR2GgwkYEI6vuA / 5)
        );

        iframe_settings.width = width_height[0];
        iframe_settings.height = width_height[1];

        var vidyard_iframe = Vidyard.Helpers.getPlayerIFrame('6A1PUCWNhR2GgwkYEI6vuA');
        var vidyard_span = document.getElementById('vidyard_span_6A1PUCWNhR2GgwkYEI6vuA');
      ...
      fade_element: function(element_to_fade, fading_in, target_alpha) {
        ...
        if (old_opacity == target_alpha) {
          ...
          if (fading_in == -1) {
            ...
            Vidyard.Helpers.getPlayerIFrame('6A1PUCWNhR2GgwkYEI6vuA').src = '';
  ...
  vidyard.box.show({
    iframe: '#', width: vidyard_player_width_6A1PUCWNhR2GgwkYEI6vuA,
    height: vidyard_player_height_6A1PUCWNhR2GgwkYEI6vuA,
    animate: !vidyard_html5_6A1PUCWNhR2GgwkYEI6vuA,
    fixed: true
  });
}
